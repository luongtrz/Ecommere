  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50/50 pb-12">
        {/* Compact Header */}
        <div className="bg-white border-b border-gray-100 mb-6 sticky top-0 z-30 shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-7 xl:col-span-8 flex flex-col gap-6">
              ...
              {step === 3 && (
                <div className="space-y-4 animate-fade-in-up">
                  <Card className="shadow-sm border border-gray-100 rounded-xl overflow-hidden">
                    <CardHeader className="bg-gray-50/50 py-3 px-4 border-b">
                      <CardTitle className="text-sm font-bold text-gray-800 uppercase tracking-wide">Kiểm tra lại thông tin</CardTitle>
                    </CardHeader>
              ...
              <div className="flex gap-3 pt-2">
                {step > 1 && (
                  <Button variant="outline" onClick={handleBackStep} className="h-11 px-6 rounded-xl border-gray-200">Quay lại</Button>
                )}
                {step < 3 ? (
                  <Button
            ...
            <div className="lg:col-span-5 xl:col-span-4">
              <div className="sticky top-20">
                <Card className="shadow-lg border-0 overflow-hidden rounded-xl bg-white ring-1 ring-black/5">
                  <CardHeader className="bg-gray-900 text-white py-4 px-5">
                  ...
                  <CardContent className="p-5">
                    <div className="space-y-3 mb-4 max-h-[350px] overflow-y-auto pr-1">
                      {items.map((item) => (
                        <div key={item.variantId} className="flex gap-3 py-2 border-b border-gray-50 last:border-0 hover:bg-gray-50/50 rounded-lg transition-colors p-1">
                          <div className="w-12 h-12 bg-gray-50 rounded-md overflow-hidden border border-gray-100 flex-shrink-0">
